...
func ExampleAbstractDeclaratorOpt_case0() {
	fmt.Println(exampleAST(177, "\U00100000 ( _Bool )") == (*AbstractDeclaratorOpt)(nil))
	// Output:
	// true
}
...
func ExampleBlockItem_decl() {
	fmt.Println(exampleAST(216, "\U00100001 a { auto ; !"))
	// Output:
	// &c99.BlockItem{
...
func ExampleBlockItemListOpt_case0() {
	fmt.Println(exampleAST(214, "\U00100001 a { }") == (*BlockItemListOpt)(nil))
	// Output:
	// false
}
...
func ExampleCommaOpt_case0() {
	fmt.Println(exampleAST(127, "\U00100000 ( _Bool ) { }") == (*CommaOpt)(nil))
	// Output:
	// true
}

func ExampleCommaOpt_case1() {
	fmt.Println(exampleAST(128, "\U00100000 ( _Bool ) { , }"))
	// Output:
	// &c99.CommaOpt{
	// · Token: ',',
	// }
...
func ExampleDeclarationList_case0() {
	fmt.Println(exampleAST(240, "\U00100001 a auto ; {"))
	// Output:
	// &c99.DeclarationList{
	// · Declaration: &c99.Declaration{
	// · · DeclarationSpecifiers: &c99.DeclarationSpecifiers{
...
func ExampleDeclarationList_case1() {
	fmt.Println(exampleAST(241, "\U00100001 a auto ; auto ; {"))
	// Output:
	// &c99.DeclarationList{
	// · Declaration: &c99.Declaration{
	// · · DeclarationSpecifiers: &c99.DeclarationSpecifiers{
...
func ExampleDeclarationListOpt_case0() {
	fmt.Println(exampleAST(242, "\U00100001 a {") == (*DeclarationListOpt)(nil))
	// Output:
	// true
}
...
func ExampleDeclarator_case0() {
	fmt.Println(exampleAST(139, "\U00100001 a )"))
	// Output:
	// &c99.Declarator{
	// · Linkage: LinkageNone,
	// · StorageDuration: StorageDurationAutomatic,
...
func ExampleDeclaratorOpt_case0() {
	fmt.Println(exampleAST(140, "\U00100001 struct { _Bool :") == (*DeclaratorOpt)(nil))
	// Output:
	// true
}

func ExampleDeclaratorOpt_case1() {
	fmt.Println(exampleAST(141, "\U00100001 struct { _Bool a :"))
	// Output:
	// &c99.DeclaratorOpt{
	// · Declarator: &c99.Declarator{
	// · · Linkage: LinkageNone,
...
func ExampleDesignatorList_case1() {
	fmt.Println(exampleAST(198, "\U00100001 auto a = { . b . c ."))
	// Output:
	// &c99.DesignatorList{
	// · Designator: &c99.Designator{
	// · · Token: '.',
...
func ExampleDirectAbstractDeclarator_dArrSize() {
	fmt.Println(exampleAST(182, "\U00100000 ( _Bool [ static 'a' ] ("))
	// Output:
	// &c99.DirectAbstractDeclarator{
	// · Case: 3,
	// · Expr: &c99.Expr{
...
func ExampleDirectAbstractDeclarator_dArrSize2() {
	fmt.Println(exampleAST(185, "\U00100000 ( _Bool [ const static 'a' ] ("))
	// Output:
	// &c99.DirectAbstractDeclarator{
	// · Case: 6,
	// · Expr: &c99.Expr{
...
func ExampleDirectAbstractDeclarator_dArr2() {
	fmt.Println(exampleAST(186, "\U00100000 ( _Bool [ const ] ("))
	// Output:
	// &c99.DirectAbstractDeclarator{
	// · Case: 7,
	// · Token: '[',
...
func ExampleDirectAbstractDeclaratorOpt_case0() {
	fmt.Println(exampleAST(187, "\U00100000 ( _Bool [") == (*DirectAbstractDeclaratorOpt)(nil))
	// Output:
	// true
}

func ExampleDirectAbstractDeclaratorOpt_case1() {
	fmt.Println(exampleAST(188, "\U00100000 ( _Bool ( ) ["))
	// Output:
...
func ExampleDirectDeclarator_paramList() {
	fmt.Println(exampleAST(146, "\U00100001 a ( auto ) ("))
	// Output:
	// &c99.DirectDeclarator{
...
func ExampleDirectDeclarator_arraySize() {
	fmt.Println(exampleAST(147, "\U00100001 a [ static 'b' ] ("))
	// Output:
	// &c99.DirectDeclarator{
...
func ExampleDirectDeclarator_arraySize2() {
	fmt.Println(exampleAST(148, "\U00100001 a [ const static 'b' ] ("))
	// Output:
	// &c99.DirectDeclarator{
...
func ExampleExternalDeclarationList_case1() {
	fmt.Println(exampleAST(231, "\U00100001 auto ; auto ;"))
	// Output:
	// &c99.ExternalDeclarationList{
	// · ExternalDeclaration: &c99.ExternalDeclaration{
	// · · Declaration: &c99.Declaration{
...
func ExampleFunctionDefinition_spec() {
	fmt.Println(exampleAST(235, "\U00100001 auto a { }"))
	// Output:
...
func ExampleFunctionSpecifier_case0() {
	fmt.Println(exampleAST(138, "\U00100001 inline ("))
	// Output:
...
func ExampleIdentifierList_case0() {
	fmt.Println(exampleAST(168, "\U00100001 a ( b )"))
	// Output:
	// &c99.IdentifierList{
	// · Token: IDENTIFIER "b",
	// }
...
func ExampleIdentifierList_case1() {
	fmt.Println(exampleAST(169, "\U00100001 a ( b , c )"))
	// Output:
	// &c99.IdentifierList{
...
func ExampleIdentifierListOpt_case0() {
	fmt.Println(exampleAST(170, "\U00100001 a ( )") == (*IdentifierListOpt)(nil))
	// Output:
	// true
}

func ExampleIdentifierListOpt_case1() {
	fmt.Println(exampleAST(171, "\U00100001 a ( b )"))
	// Output:
...
func ExampleIdentifierOpt_case0() {
	fmt.Println(exampleAST(172, "\U00100001 struct {") == (*IdentifierOpt)(nil))
	// Output:
	// true
}

func ExampleIdentifierOpt_case1() {
	fmt.Println(exampleAST(173, "\U00100001 enum a {"))
	// Output:
	// &c99.IdentifierOpt{
	// · Token: IDENTIFIER "a",
	// }
...
func ExampleInitializer_compLit() {
	fmt.Println(exampleAST(189, "\U00100001 auto a = { } ,"))
	// Output:
	// &c99.Initializer{
	// · Token: '{',
	// · Token2: '}',
...
func ExampleInitializerList_case0() {
	fmt.Println(exampleAST(191, "\U00100000 ( _Bool ) { ,") == (*InitializerList)(nil))
	// Output:
	// true
}
...
func ExampleInitializerList_case4() {
	fmt.Println(exampleAST(195, "\U00100000 ( _Bool ) { , . a = 'b' ,"))
	// Output:
	// &c99.InitializerList{
	// · Case: 4,
	// · Designation: &c99.Designation{
...
func ExampleIterationStmt_do() {
	fmt.Println(exampleAST(222, "\U00100001 a { do ; while ( 'b' ) ; !"))
	// Output:
	// &c99.IterationStmt{
	// · ExprList: &c99.ExprList{
	// · · Expr: &c99.Expr{
...
func ExampleIterationStmt_forDecl() {
	fmt.Println(exampleAST(223, "\U00100001 a { for ( auto ; ; ) ; !"))
	// Output:
	// &c99.IterationStmt{
	// · Case: 1,
	// · Declaration: &c99.Declaration{
...
func ExampleIterationStmt_for() {
	fmt.Println(exampleAST(224, "\U00100001 a { for ( ; ; ) ; !"))
	// Output:
	// &c99.IterationStmt{
	// · Case: 2,
	// · Stmt: &c99.Stmt{
...
func ExampleIterationStmt_while() {
	fmt.Println(exampleAST(225, "\U00100001 a { while ( 'b' ) ; !"))
	// Output:
	// &c99.IterationStmt{
	// · Case: 3,
	// · ExprList: &c99.ExprList{
...
func ExampleJumpStmt_break() {
	fmt.Println(exampleAST(226, "\U00100001 a { break ; !"))
	// Output:
	// &c99.JumpStmt{
	// · Token: BREAK "break",
	// · Token2: ';',
...
func ExampleJumpStmt_continue() {
	fmt.Println(exampleAST(227, "\U00100001 a { continue ; !"))
	// Output:
	// &c99.JumpStmt{
	// · Case: 1,
...
func ExampleJumpStmt_goto() {
	fmt.Println(exampleAST(228, "\U00100001 a { goto b ; !"))
	// Output:
	// &c99.JumpStmt{
	// · Case: 2,
	// · Token: GOTO "goto",
...
func ExampleJumpStmt_return() {
	fmt.Println(exampleAST(229, "\U00100001 a { return ; !"))
	// Output:
	// &c99.JumpStmt{
	// · Case: 3,
	// · Token: RETURN "return",
...
func ExampleLabeledStmt_switchCase() {
	fmt.Println(exampleAST(207, "\U00100001 a { case 'b' : ; !"))
	// Output:
	// &c99.LabeledStmt{
	// · ConstExpr: &c99.ConstExpr{
	// · · Expr: &c99.Expr{
...
func ExampleLabeledStmt_default() {
	fmt.Println(exampleAST(208, "\U00100001 a { default : ; !"))
	// Output:
	// &c99.LabeledStmt{
	// · Case: 1,
	// · Stmt: &c99.Stmt{
...
func ExampleLabeledStmt_label() {
	fmt.Println(exampleAST(209, "\U00100001 a { b : ; !"))
	// Output:
	// &c99.LabeledStmt{
	// · Case: 2,
	// · Stmt: &c99.Stmt{
...
func ExampleParameterDeclaration_declarator() {
	fmt.Println(exampleAST(167, "\U00100001 a ( auto b )"))
	// Output:
	// &c99.ParameterDeclaration{
	// · Case: 1,
	// · DeclarationSpecifiers: &c99.DeclarationSpecifiers{
...
func ExampleParameterList_case1() {
	fmt.Println(exampleAST(165, "\U00100001 a ( auto , auto )"))
	// Output:
	// &c99.ParameterList{
	// · ParameterDeclaration: &c99.ParameterDeclaration{
	// · · DeclarationSpecifiers: &c99.DeclarationSpecifiers{
...
func ExampleParameterTypeListOpt_case0() {
	fmt.Println(exampleAST(162, "\U00100000 ( _Bool ( )") == (*ParameterTypeListOpt)(nil))
	// Output:
	// true
}

func ExampleParameterTypeListOpt_case1() {
	fmt.Println(exampleAST(163, "\U00100000 ( _Bool ( auto )"))
	// Output:
...
func ExamplePointerOpt_case0() {
	fmt.Println(exampleAST(154, "\U00100001 (") == (*PointerOpt)(nil))
	// Output:
	// true
}
...
func ExampleSelectionStmt_ifElse() {
	fmt.Println(exampleAST(219, "\U00100001 a { if ( 'b' ) ; else ; !"))
	// Output:
	// &c99.SelectionStmt{
	// · ExprList: &c99.ExprList{
	// · · Expr: &c99.Expr{
...
func ExampleSelectionStmt_if() {
	fmt.Println(exampleAST(220, "\U00100001 a { if ( 'b' ) ; !"))
	// Output:
	// &c99.SelectionStmt{
	// · Case: 1,
	// · ExprList: &c99.ExprList{
...
func ExampleSelectionStmt_switch() {
	fmt.Println(exampleAST(221, "\U00100001 a { switch ( 'b' ) ; !"))
	// Output:
	// &c99.SelectionStmt{
	// · Case: 2,
	// · ExprList: &c99.ExprList{
...
func ExampleSpecifierQualifierList_qualifier() {
	fmt.Println(exampleAST(119, "\U00100000 ( const ("))
	// Output:
...
func ExampleSpecifierQualifierListOpt_case0() {
	fmt.Println(exampleAST(121, "\U00100000 ( const (") == (*SpecifierQualifierListOpt)(nil))
	// Output:
	// true
}

func ExampleSpecifierQualifierListOpt_case1() {
	fmt.Println(exampleAST(122, "\U00100000 ( const _Bool ("))
	// Output:
...
func ExampleStmt_iter() {
	fmt.Println(exampleAST(203, "\U00100001 a { while ( 'b' ) ; !"))
	// Output:
	// &c99.Stmt{
	// · Case: 2,
...
func ExampleStmt_jump() {
	fmt.Println(exampleAST(204, "\U00100001 a { break ; !"))
	// Output:
	// &c99.Stmt{
	// · Case: 3,
...
func ExampleStmt_labeled() {
	fmt.Println(exampleAST(205, "\U00100001 a { default : ; !"))
	// Output:
	// &c99.Stmt{
	// · Case: 4,
...
func ExampleStmt_select() {
	fmt.Println(exampleAST(206, "\U00100001 a { if ( 'b' ) ; !"))
	// Output:
	// &c99.Stmt{
	// · Case: 5,
...
func ExampleStructDeclaration_anon() {
	fmt.Println(exampleAST(118, "\U00100001 struct { _Bool ; }"))
	// Output:
	// &c99.StructDeclaration{
	// · Case: 1,
	// · SpecifierQualifierList: &c99.SpecifierQualifierList{
...
func ExampleStructDeclarationList_case0() {
	fmt.Println(exampleAST(115, "\U00100001 struct { _Bool ; }"))
	// Output:
...
func ExampleStructDeclarationList_case1() {
	fmt.Println(exampleAST(116, "\U00100001 struct { _Bool ; _Bool ; }"))
	// Output:
	// &c99.StructDeclarationList{
	// · StructDeclaration: &c99.StructDeclaration{
	// · · Case: 1,
...
func ExampleStructDeclaratorList_case1() {
	fmt.Println(exampleAST(124, "\U00100001 struct { _Bool a , b ,"))
	// Output:
	// &c99.StructDeclaratorList{
	// · StructDeclarator: &c99.StructDeclarator{
	// · · Declarator: &c99.Declarator{
...
func ExampleStructOrUnion_struct() {
	fmt.Println(exampleAST(113, "\U00100001 struct {"))
	// Output:
	// &c99.StructOrUnion{
	// · Token: STRUCT "struct",
	// }
...
func ExampleStructOrUnion_union() {
	fmt.Println(exampleAST(114, "\U00100001 union {"))
	// Output:
	// &c99.StructOrUnion{
	// · Case: 1,
	// · Token: UNION "union",
...
func ExampleTypeQualifier_const() {
	fmt.Println(exampleAST(135, "\U00100001 const !"))
	// Output:
	// &c99.TypeQualifier{
	// · Token: CONST "const",
	// }
...
func ExampleTypeQualifier_restrict() {
	fmt.Println(exampleAST(136, "\U00100001 restrict !"))
	// Output:
	// &c99.TypeQualifier{
	// · Case: 1,
...
func ExampleTypeQualifier_volatile() {
	fmt.Println(exampleAST(137, "\U00100001 volatile !"))
	// Output:
	// &c99.TypeQualifier{
	// · Case: 2,
...
func ExampleTypeQualifierList_case0() {
	fmt.Println(exampleAST(156, "\U00100001 * const !"))
	// Output:
...
func ExampleTypeQualifierList_case1() {
	fmt.Println(exampleAST(157, "\U00100001 * const const !"))
	// Output:
	// &c99.TypeQualifierList{
	// · TypeQualifier: &c99.TypeQualifier{
	// · · Token: CONST "const",
...
func ExampleTypeQualifierListOpt_case0() {
	fmt.Println(exampleAST(158, "\U00100001 * (") == (*TypeQualifierListOpt)(nil))
	// Output:
	// true
}

func ExampleTypeQualifierListOpt_case1() {
	fmt.Println(exampleAST(159, "\U00100001 * const !"))
	// Output:
